...
const Mid = () => {
  return (
    <div className="py-4 px-8 mb-24 grid place-content-center   mx-auto max-w-7xl w-11/12 backdrop-blur-[2px]">
      <p className="text-gray-100 text-5xl my-5 font-font-3 font-bold">Search. Find. Connect!</p>
      <div>
      ...
      <form className="flex gap-3 w-full max-sm:grid">
        ...
        <div className="flex items-center max-sm:justify-center">
          <button className="font-font-1 rounded-sm outline-none border-2 border-l-teal-100 px-4 py-1 h-9 bg-green-500">search</button>
        </div>
      </form>
    </div>
