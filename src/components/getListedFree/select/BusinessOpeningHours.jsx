    ...
    return (
        <>
                    ...
                    <div title="open 24 hours a day, seven day a week. CheckBox" className="flex gap-2 items-center m-auto ml-28 duration-200 ease-in cursor-pointer max-lg:flex-wrap">
                        {
                            !openAllDayAndWeek ?
                                ...
                                :
                                <CheckBoxOutlined onClick={() => setOpenAllDayAndWeek(!openAllDayAndWeek)} className={openAllDayAndWeek && "text-blue-600"} />
                        }
            ...
            <div className="flex gap-10 justify-center m-auto w-full max-lg:flex-wrap">
                ...
                <div title="Opening time" className={`relative w-full duration-200 ease-in group flex flex-col-reverse
                    ...
                    <label
                        ...
                        ${openAllDayAndWeek ? "text-gray-600 cursor-not-allowed -z-1" : "text-white"}
                        `}
                ...
                <div title="closing time" className={` relative w-full duration-200 ease-in group flex flex-col-reverse
                ${openAllDayAndWeek && "cursor-not-allowed opacity-50 "}
                `}>
            ...
            <div className="flex gap-10 justify-center m-auto w-full max-lg:flex-wrap">
                ...
                <div title="from which day day Business will be closed" className={`relative w-full flex flex-col-reverse duration-200 ease-in group ${openAllDayAndWeek && "cursor-not-allowed opacity-50"}`}>
                    ...
                    <select
                        ...
                        className={`ease-in duration-200 peer bg-[#1a1f2d] w-full outline-none pl-3 text-sm appearance-none h-12 text-b-[1px] rounded-sm border-[1px]  border-gray-300 dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 ${openAllDayAndWeek ? "text-gray-900 cursor-not-allowed -z-1" : "cursor-pointer"}`}
                    >
                    ...
                    <label
                        htmlFor="dayofffrom"
                        className={`block mb-2 text-sm font-medium text-left peer-focus:text-blue-600 peer-focus:dark:text-blue-500 ${openAllDayAndWeek ? "text-gray-500 cursor-not-allowed -z-1" : "text-white"}`}
                    >
                        From
                    </label>
                </div>
                <div title="till which day the business will be close" className={`relative w-full duration-200 flex flex-col-reverse ease-in group 
        ${openAllDayAndWeek && "cursor-not-allowed opacity-50 "}
        `}>
