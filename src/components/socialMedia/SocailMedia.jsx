...
const SocailMedia = () => {
  return (
    <div className="flex flex-wrap gap-8 justify-center mt-14 mb-8 ">
      <div className="fb-share-button flex hover:animate-button-shake items-center bg-[#0062ff] py-1 px-3 rounded-md text-white text-stone-200 cursor-pointer" data-href="https://tejbahadurkarki.com.np" data-layout="" data-size="">
