      ...
      <div className="flex flex-col gap-10 font-font-6">
        ...
        <div className="flex gap-y-1 gap-4 justify-end mt-2 w-full duration-200 ease-in cursor-pointer max-lg:flex-wrap">
          <button type="submit" className="relative rounded px-3 text-base py-2.5 overflow-hidden group bg-green-500 hover:bg-gradient-to-r hover:from-green-500 hover:to-green-400 text-white hover:ring-2 hover:ring-offset-2 hover:ring-green-400 hover:ring-offset-[#151924] transition-all ease-out duration-300">
            <svg aria-hidden="true" role="status" className={` ${loading ? "inline" : "hidden"}  inline mr-3 w-4 h-4 text-white animate-loading-circle`} viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
