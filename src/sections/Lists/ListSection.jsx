...
const ListSection = () => {
  ...
  const handlePage = (e, value) => {
    e.preventDefault();
    if (value === "next") {
      if (data?.totalPages > data?.currentPage || !isFetching) {
        setPage(data?.currentPage + 1);
      }
    } else {
      if (data?.currentPage > 1 || !isFetching) {
        setPage(data?.currentPage - 1);
      }
    }
  };
  ...
  return (
    <section className="bg-slate-100">
      ...
      <div className="flex justify-center px-4 pt-16 m-auto max-w-screen-xl max-md:flex-col">
        ...
        <aside className="sm:flex-[0.5] sm:ml-6 bg-[#5c47cf] rounded-md">
          ...
          <div className=" relative h-[63%] px-2 py-3">
                    ...
                    return (
                      ...
                      >
                        {isFetching && datas ? (
                          <svg
                            aria-hidden="true"
                            className={`inline z-10 w-4 h-4 text-black animate-loading-circle`}
                            viewBox="0 0 100 101"
                            fill="none"
                            xmlns="http://www.w3.org/2000/svg"
                          >
